...
|---|---|---|
| **01 · Aircraft forces and airfoils** | Flight-path equilibrium, flight controls, CG, trim and static margin; airfoil geometry, NACA sections, wing and empennage anatomy, spoilers/spoilerons, stall and structural load paths · Multi-session lecture | [![Open Lecture 01 in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Ehsan-Roohi/Aerospace-Structures/blob/main/notebooks/MIE446_Lecture_01_Trust_Forces_Airfoils.ipynb) |
